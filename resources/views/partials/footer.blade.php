                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                    <div class="footer-item fi-2 clearfix">
                        <div class="footer-gallery clearfix">
                            ...
                            <ul>
                                <li>
                                    <img src="{{ asset('assets/img/sub-property/sub-property.png') }}" alt="small-img">
                                </li>
                                <li>
                                    <img src="{{ asset('assets/img/sub-property/sub-property-2.png') }}" alt="small-img">
                                </li>
                                <li>
                                    <img src="{{ asset('assets/img/sub-property/sub-property-3.png') }}" alt="small-img">
                                </li>
                                <li>
                                    <img src="{{ asset('assets/img/sub-property/sub-property-4.png') }}" alt="small-img">
                                </li>
                                <li>
                                    <img src="{{ asset('assets/img/sub-property/sub-property-5.png') }}" alt="small-img">
                                </li>
                                <li>
                                    <img src="{{ asset('assets/img/sub-property/sub-property-6.png') }}" alt="small-img">
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div id="modalCarousel" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active">
                                        <img src="{{ asset('assets/img/img-8.png') }}" alt="Property Video Placeholder">
                                        <div class="video-overlay">
                                            <i class="fa fa-play-circle" style="font-size: 48px; color: #fff; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);"></i>
                                        </div>
                                    </div>
